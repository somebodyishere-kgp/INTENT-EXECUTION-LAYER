...
void CliParser::PrintHelp() {
    ...
    std::cout << "  iee ure debug [--bundles] [--continuous] [--json]\n";
    std::cout << "  iee ure skills [--active] [--limit <N>] [--json]\n";
    std::cout << "  iee ure anticipation [--json]\n";
    std::cout << "  iee ure strategy [--json]\n";
